...
namespace Multi_VendorE_CommercePlatform.Migrations
{
    ...
    [Migration("20241207125314_Initial")]
            ...
            modelBuilder.Entity("Multi_VendorE_CommercePlatform.Models.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2465bcd2-74fe-4633-a23a-a8ee66442582"),
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("3b584dfe-7005-41c5-994f-adf26a3faaa2"),
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = new Guid("97d6d77a-b916-4581-95b8-32701fa7e940"),
                            Name = "Vendor",
            ...
            modelBuilder.Entity("Multi_VendorE_CommercePlatform.Models.Customer", b =>
                {
                    b.HasOne("Multi_VendorE_CommercePlatform.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("Multi_VendorE_CommercePlatform.Models.Customer", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Multi_VendorE_CommercePlatform.Models.Vendor", b =>
                {
                    b.HasOne("Multi_VendorE_CommercePlatform.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("Multi_VendorE_CommercePlatform.Models.Vendor", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
